...
//	unsigned char RH,RL,TH,TL,CHECK;
	...
	OLED_ShowNum(40,0,RH,2,OLED_8X16);
	OLED_ShowNum(40,33,TH,2,OLED_8X16);
	OLED_ShowNum(40,49,TL,2,OLED_8X16);
	
	OLED_ShowHexNum(0, 0, rec_data[0], 2, OLED_8X16);
	OLED_ShowHexNum(0, 17, rec_data[1], 2, OLED_8X16);
	OLED_ShowHexNum(0, 33, rec_data[2], 2, OLED_8X16);
	OLED_ShowHexNum(0, 49, rec_data[3], 2, OLED_8X16);
	OLED_Update();
}
